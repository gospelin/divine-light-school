...
@push('styles')
    <style>
        ...
        .total-excellent { background-color: #d4edda !important; color: #155724; }
        .total-good      { background-color: #d1ecf1 !important; color: #0c5460; }
        .total-average   { background-color: #fff3cd !important; color: #856404; }
        .total-below     { background-color: #f8d7da !important; color: #721c24; }
        .total-fail      { background-color: #f5c6cb !important; color: #721c24; font-weight: bold; }
...
@section('content')
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        ...
        <div class="mb-6 text-center md:text-left">
            ...
            <div class="mt-4 inline-block bg-amber-100 text-amber-800 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold">
        ...
        <div class="mb-6 bg-white rounded-xl shadow-md p-5 sm:p-6 border">
            <form action="{{ route('teacher.results.broadsheet', $class) }}" method="GET"
                ...
                <div class="hidden lg:flex lg:items-end">
                    <div class="bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-800 px-4 py-2 rounded-lg text-sm font-medium">
        ...
        @else
                    ...
                    <table class="w-full min-w-max text-sm">
                        <thead>
                            <tr class="bg-gradient-to-b from-gray-100 to-gray-200">
                                <th rowspan="2" class="sticky left-0 bg-gray-200 z-30 px-4 sm:px-6 py-3 text-left font-bold border-r border-gray-400 min-w-[140px]">
                                    Subjects
                                </th>
                                @foreach($students as $student)
                                    <th colspan="4" class="px-3 sm:px-6 py-3 text-center font-medium border-x border-gray-300 min-w-[160px]">
                        ...
                        <tbody class="divide-y divide-gray-200">
                                    ...
                                    @foreach($students as $student)
                                        ...
                                        <td class="px-2 sm:px-3 py-4 text-center border-x">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <div class="status-indicator" id="status_{{ $student->id }}_{{ $classSubjectId }}"></div>
                                            </div>
                                        </td>
                            ...
                            <tr class="bg-purple-50">
                                <td class="sticky left-0 bg-purple-100 z-20 px-4 sm:px-6 py-4 border-r border-gray-400 font-medium">
                                    Principal Comment
                                </td>
                                @foreach($students as $student)
                                    @php
                            ...
                            <tr class="bg-green-50">
                                <td class="sticky left-0 bg-green-100 z-20 px-4 sm:px-6 py-4 border-r border-gray-400 font-medium">
            ...
            <div class="fixed bottom-4 right-4 z-50" id="save-notice">
                <div class="notice-inner bg-green-600 text-white px-5 py-3 rounded-full shadow-2xl text-sm font-medium flex items-center gap-3">
