...
@section('content')
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border p-10">
            ...
            @endif
            <h1 class="text-3xl font-bold mb-8 text-center text-blue-900">EDIT TEACHER</h1>
            ...
            <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST">
                ...
                <!-- Same fields as create, with old() + model values -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_employed" value="{{ old('date_employed', $teacher->date_employed?->format('Y-m-d')) }}"
                               class="w-full border rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500" required>
                    </div>
                </div>
                ...
                <div class="mb-10">
                    ...
                    <textarea name="address" rows="4" class="w-full border rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500" required>{{ old('address', $teacher->address) }}</textarea>
                </div>

                <div class="mb-10">
                    <label class="block text-lg font-semibold mb-3">Bio / Notes (Optional)</label>
                    <textarea name="bio" rows="5" class="w-full border rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500">{{ old('bio', $teacher->bio) }}</textarea>
                </div>

                <div class="mb-10">
                    <label class="block text-lg font-semibold mb-3">Assign Classes (Current Session)</label>
                ...
                <div class="flex justify-end gap-6">
                    ...
                    <a href="{{ route('admin.teachers.index') }}" class="px-10 py-4 border-2 border-gray-300 rounded-lg hover:bg-gray-50 text-xl font-medium">
                        Cancel
                    </a>
                </div>
            </form>
